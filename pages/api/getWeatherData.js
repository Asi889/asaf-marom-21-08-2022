...
export default async function getWeatherData(req, res) {
  ...
  const {data} = await axios.get(`http://dataservice.accuweather.com/currentconditions/v1/${req.body.cityKey}?apikey=aYXoTbrCBr8tCeEOmwtrk4ef1wTQCXFM`)
  const forcast = await axios.get(`http://dataservice.accuweather.com/forecasts/v1/daily/5day/${req.body.cityKey}?apikey=aYXoTbrCBr8tCeEOmwtrk4ef1wTQCXFM&metric=true`)
